"""Custom Ultralytics model glue for TorchVision backbones and alternate heads."""
...
class YOLOv8BackboneAdapter(nn.Module):
    """Project TorchVision feature maps into YOLO-friendly channels with optional CSP/attention glue."""
...
class YOLOv8VGGBackboneAdapter(YOLOv8BackboneAdapter):
    """Specialised adapter with a slightly deeper refinement stack for VGG backbones."""
...
class YOLOv8DetectHead(Detect):
    """Thin wrapper around the stock Detect head to allow YAML pluggability under a distinct name."""
